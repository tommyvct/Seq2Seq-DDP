...
python3 transition_predict.py --train_corpus molweni --test_corpus molweni -s natural2 -t t5gemma2 -m 4b --lr 2e-5 --batchsize 4 --step 2000 --seed 27 -b
echo "Inference Complete"
python3 eval_gen.py --fted_model t5gemma2-4b --train_corpus molweni --test_corpus molweni -s natural2 --lr 2e-5 --batchsize 4 --step 2000 --seed 27 > eval/t5gemma2-4b_2e-5_e5_b4_s2000_molweni_natural2.txt
EOF
...
echo "Inference Complete"
python3 eval_gen.py --fted_model t5gemma2-4b --train_corpus molweni --test_corpus molweni -s natural2 --lr 5e-6 --batchsize 4 --step 2000 --seed 27 > eval/t5gemma2-4b_5e-6_e5_b4_s2000_molweni_natural2.txt
EOF
...
echo "Training Complete"
python3 transition_predict.py --train_corpus molweni --test_corpus molweni -s natural2 -t t5gemma2 -m 4b --lr 5e-6 --batchsize 4 --step 2000 --seed 27 --warmup_ratio 0.1 --max_grad_norm 0.5 --weight_decay 0.01 -b
echo "Inference Complete"
python3 eval_gen.py --fted_model t5gemma2-4b --train_corpus molweni --test_corpus molweni -s natural2 --lr 5e-6 --batchsize 4 --step 2000 --seed 27 --warmup_ratio 0.1 --max_grad_norm 0.5 --weight_decay 0.01 > eval/t5gemma2-4b_5e-6_e5_b4_s2000_molweni_natural2_warmup.txt
EOF
...
echo "Training Complete"
python3 transition_predict.py --train_corpus molweni --test_corpus molweni -s natural2 -t t5gemma2 -m 4b  --lr 5e-6 --batchsize 4 --step 2000 --seed 27 --new_prompt --warmup_ratio 0.1 --max_grad_norm 0.5 --weight_decay 0.01 -b
echo "Inference Complete"
python3 eval_gen.py --fted_model t5gemma2-4b --train_corpus molweni --test_corpus molweni -s natural2 --lr 5e-6 --batchsize 4 --step 2000 --seed 27 --new_prompt --warmup_ratio 0.1 --max_grad_norm 0.5 --weight_decay 0.01 > eval/t5gemma2-4b_5e-6_e5_b4_s2000_molweni_natural2_newprompt_warmup.txt
EOF
...
python3 transition_predict.py --train_corpus molweni --test_corpus molweni -s natural2 -t t0gemma2 -m 4b --lr 2e-5 --batchsize 4 --step 2000 --seed 27 -b
python3 eval_gen.py --fted_model t0gemma2-4b --train_corpus molweni --test_corpus molweni -s natural2 --lr 2e-5 --batchsize 4 --step 2000 --seed 27 > eval/t0gemma2-4b_2e-5_e5_b4_s2000_molweni_natural2.txt
