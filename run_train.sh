...
python3 train.py --train_corpus molweni --do_train -s natural -t t0-3b -l 5e-5 -e 10 --batchsize 4 --step 500 -b
...
python3 train.py --train_corpus molweni --do_train -s augmented -t t0-3b -l 5e-5 -e 10 --batchsize 4 --step 500 -b
...
python3 train.py --train_corpus molweni --do_train -s focus -t t0-3b -l 5e-5 -e 5 --batchsize 4 --step 2000 -b
...
python3 train.py --train_corpus molweni --do_train -s natural2 -t t0-3b -l 5e-5 -e 5 --batchsize 4 --step 2000 -b
...
python3 train.py --train_corpus stac --do_train -s natural -t t0-3b -l 5e-5 -e 20 --batchsize 4 --step 500 -b
...
python3 train.py --train_corpus stac --do_train -s augmented -t t0-3b -l 5e-5 -e 20 --batchsize 4 --step 500 -b
