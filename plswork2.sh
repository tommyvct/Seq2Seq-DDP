...
python3 eval_gen.py --fted_model t5gemma2-4b --train_corpus molweni --test_corpus molweni -s natural2 --lr 5e-6 --seed 27 > eval/t5gemma2-4b_5e-6_e3_b4_molweni_natural2.txt
EOF
...
python3 transition_predict.py --train_corpus molweni --test_corpus molweni -s natural2 -t t5gemma2 -m 4b --lr 5e-6 --seed 27 --new_prompt -b
echo "Inference Complete"

python3 eval_gen.py --fted_model t5gemma2-4b --train_corpus molweni --test_corpus molweni -s natural2 --lr 5e-6 --seed 27 --new_prompt > eval/t5gemma2-4b_5e-6_e5_b4_molweni_natural2_newprompt.txt
INNER_EOF
...
python3 eval_gen.py --fted_model t5gemma2-4b --train_corpus molweni --test_corpus molweni -s natural2 --lr 5e-6 --seed 27 > eval/t5gemma2-4b_5e-6_e5_b16_molweni_natural2.txt
INNER_EOF
...
python3 eval_gen.py --fted_model t5gemma2-4b --train_corpus molweni --test_corpus molweni -s natural2 --lr 5e-6 --seed 27 --new_prompt > eval/t5gemma2-4b_5e-6_e5_b16_molweni_natural2_newprompt.txt
INNER_EOF
