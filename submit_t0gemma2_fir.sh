...
JID_TRAIN_1B_FOCUS=$(sbatch --parsable <<'EOT'
#!/bin/bash
...
JID_TRAIN_1B_NAT2=$(sbatch --parsable <<'EOT'
#!/bin/bash
...
ALL_INF_JIDS="$JID_INF_1B_FOCUS:$JID_INF_1B_NAT2"
...
#SBATCH --mail-type=FAIL,END
#SBATCH --mail-user=wut2@unbc.ca
#SBATCH --cpus-per-task=2 --mem=4G --time=00:10:00
